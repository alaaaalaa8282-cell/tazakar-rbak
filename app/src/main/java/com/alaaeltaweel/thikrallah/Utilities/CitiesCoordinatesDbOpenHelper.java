...
import com.alaaeltaweel.thikrallah.hisnulmuslim.database.HisnDatabaseInfo;
...
public class CitiesCoordinatesDbOpenHelper extends SQLiteOpenHelper {
    ...
    //This piece of code will create a com.alaaeltaweel.thikrallah.cities_coordinates.sqlite3 if it’s not yet created
    public void createDataBase() {
        ...
        if (!dbExist) {
            ...
            try {
                ...
                throw new Error("Error copying com.alaaeltaweel.thikrallah.cities_coordinates.sqlite3!");
            }
        } else {
    ...
    //Performing a com.alaaeltaweel.thikrallah.cities_coordinates.sqlite3 existence check
    ...
    //Method for copying the com.alaaeltaweel.thikrallah.cities_coordinates.sqlite3
    private void copyDataBase() throws IOException {
        //Open a stream for reading from our ready-made com.alaaeltaweel.thikrallah.hisnulmuslim.database
        //The stream source is located in the assets
        InputStream externalDbStream = context.getAssets().open(DB_NAME);
        Log.d(TAG,"copying database from asset to database directory");
        //Path to the created empty com.alaaeltaweel.thikrallah.cities_coordinates.sqlite3 on your Android device
        ...
        //Now create a stream for writing the com.alaaeltaweel.thikrallah.cities_coordinates.sqlite3 byte by byte
        OutputStream localDbStream = new FileOutputStream(outFileName);

        //Copying the com.alaaeltaweel.thikrallah.cities_coordinates.sqlite3
