package com.alaaeltaweel.thikrallah.quran.labs.androidquran;
...
import com.alaaeltaweel.thikrallah.quran.labs.androidquran.util.CopyDatabaseUtil;
import com.alaaeltaweel.thikrallah.quran.labs.androidquran.util.QuranFileUtils;
import com.alaaeltaweel.thikrallah.quran.labs.androidquran.util.QuranPartialPageChecker;
...
public class QuranDataActivity extends Activity implements
  ...
  private void checkPermissions() {
    ...
    boolean usesExternalFileDir = path != null && path.contains("com.alaaeltaweel.thikrallah.quran");
