package com.alaaeltaweel.thikrallah.quran.labs.androidquran.util;
...
public class QuranSettings {
  private static final String PREFS_FILE = "com.alaaeltaweel.thikrallah.quran.labs.androidquran.per_installation";
